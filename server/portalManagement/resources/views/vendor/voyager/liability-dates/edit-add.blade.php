                                            ...
                                            <div class="form-group">
                                                <select class="form-control" name="liability_id">
                                                    <option value="">Select Liability</option>
                                                        @foreach('App\Models\Liability'::all() as $liability)
                                                            <option value="{{ $liability->id }}" {{ $dataTypeContent->liability_id == $liability->id ? 'selected' : '' }}>{{ $liability->id }}</option>
                                                        @endforeach
                                                </select>
                                            </div>
                                        @elseif($row->field == 'is_paid')
                                            <div class="form-group">
